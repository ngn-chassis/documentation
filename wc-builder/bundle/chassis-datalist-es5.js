  ...
  return (
    ...
    function (_HTMLElement) {
      ...
      function _class() {
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).addReadOnlyProp('options');

        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).options = [];

        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).find = function (query) {
          return _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).options.filter(function (option) {
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).clear = function () {
          _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).options.forEach(function (option) {
            return option.displayElement.style.display = 'none';
          });
        };

        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).showAllOptions = function () {
          _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).options.forEach(function (option) {
            return option.displayElement.style.display = '';
          });
        };

        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).clickHandler = function (evt) {
          _this.clickCount++;

          if (_this.clickCount === 2) {
            _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).showAllOptions();

            _this.open();
          }
        };

        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).keydownHandler = function (evt) {
          if (!_this.isOpen) {
            _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).showAllOptions();
          ...
          switch (evt[_this.keySource]) {
            case 27:
            case 'Escape':
              _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).clear();
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).inputHandler = function (evt) {
          _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).clear();

          var query = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).inputEl.value;

          if (!query) {
            return;
          }

          var results = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).find(query);
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).bodyClickHandler = function (evt) {
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).getOptionById = function (id) {
          var options = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).options;
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).generateOptionObject = function (optionEl) {
          ...
          var obj = {
            id: _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).generateGuid('option'),
            attributes: {},
      ...
      (0, _createClass2.default)(_class, [{
        ...
        value: function connectedCallback() {
          ...
          _private.get(this).inputEl.addEventListener('blur', function (evt) {
            _this2.clickCount = 0;

            _this2.removeEventListener('keydown', _private.get(_this2).keydownHandler);
          });
        ...
        value: function addOption(option, index) {
          ...
          this["".concat(_private.get(this).options.length)] = option.sourceElement;
        ...
        value: function select(id) {
          var option = _private.get(this).getOptionById(id);
          ...
          if (option) {
            ...
            _private.get(this).options.forEach(function (option) {
