...
var AuthorGridCellElement =
/*#__PURE__*/
function (_HTMLElement) {
  (0, _inherits2.default)(AuthorGridCellElement, _HTMLElement);

  function AuthorGridCellElement() {
    (0, _classCallCheck2.default)(this, AuthorGridCellElement);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AuthorGridCellElement).call(this)); // this.UTIL.defineAttributes({
    //   max: {
    //     default: 'auto',
    //
    //     set: value => {
  ...
  (0, _createClass2.default)(AuthorGridCellElement, [{
  ...
  return AuthorGridCellElement;
}((0, _wrapNativeSuper2.default)(HTMLElement));

customElements.define('author-grid-cell', AuthorGridCellElement);
...
/***/ })
/******/ ]);
//# sourceMappingURL=author-grid-cell-es5-bundle.js.map