  ...
  return (
    ...
    function (_HTMLElement) {
      ...
      function _class() {
        ...
        _.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).addReadOnlyProp('options');
      ...
      (0, _createClass2.default)(_class, [{
        ...
        value: function attributeChangedCallback(attr, oldValue, newValue) {
          ...
          switch (attr) {
            case 'autofocus':
            case 'disabled':
              console.log(attr); // _.get(this).handleBooleanAttributeChange(attr, newValue)

              break;

            case 'name':
              console.log(attr); // _.get(this).handleAttributeChange(attr, newValue)
