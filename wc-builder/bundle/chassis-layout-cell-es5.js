    ...
    function (_HTMLElement) {
      ...
      (0, _createClass2.default)(_class, [{
        ...
        value: function connectedCallback() {
          ...
          setTimeout(function () {
            _private.get(_this2).styleSheet = _this2.shadowRoot.styleSheets[0];

            var sheetLength = _private.get(_this2).styleSheet.cssRules.length;

            _private.get(_this2).styleSheet.insertRule(':host([size]) {}', sheetLength);

            _private.get(_this2).sizeRule = _private.get(_this2).styleSheet.cssRules[sheetLength];
