    ...
    function (_HTMLElement) {
      ...
      function _class() {
        ...
        _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).addPrivateProps({
          ...
          initDatalist: function initDatalist(input, datalist) {
            ...
            var placeholder = document.createElement('chassis-datalist');
            ...
            try {
              for (var _iterator = datalist.attributes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            placeholder.inject(input, datalist, _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).guid);

            _this.appendChild(placeholder);

            _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).input = placeholder;
          },
          initInput: function initInput(input) {
            input.slot = input.slot || 'input';
            _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).input = input;
            input.id = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).guid;

            if (_private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).fieldInputTypes.indexOf(input.type) >= 0) {
              _this.type = 'field';
            }

            if (_private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).toggleInputTypes.indexOf(input.type) >= 0) {
              _this.type = 'toggle';
            }
          },
          initLabel: function initLabel(label) {
            ...
            label.htmlFor = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).guid;
          ...
          initSelectMenu: function initSelectMenu(select) {
            ...
            if (!customElements.get('chassis-select')) {
              select.id = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).guid;
              select.slot = select.slot || 'input';
              select.setAttribute('role', 'menu');
              _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).input = select;
            ...
            var placeholder = document.createElement('chassis-select');
            placeholder.slot = 'input';
            placeholder.id = _private.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).guid;
            var _iteratorNormalCompletion3 = true;
            var _didIteratorError3 = false;
            var _iteratorError3 = undefined;

            try {
              for (var _iterator3 = select.attributes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      (0, _createClass2.default)(_class, [{
        ...
        value: function connectedCallback() {
          ...
          setTimeout(function () {
            var label = _this2.querySelector('label');

            var input = _this2.querySelector('input');

            var textarea = _this2.querySelector('textarea');

            var select = _this2.querySelector('select');

            var datalist = _this2.querySelector('datalist');

            textarea && _private.get(_this2).initInput(textarea);
            select && _private.get(_this2).initSelectMenu(select);
