...
customElements.define('author-grid',
/*#__PURE__*/
function (_AuthorElement) {
  ...
  function _class() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(_class).call(this, "<template><style>@charset \"UTF-8\"; :host{display:grid}:host([inline]){display:inline-grid}author-grid{display:grid}author-grid[inline]){display:inline-grid}</style><slot></slot></template>"));
