...
var AuthorSelectedOptionsElement =
/*#__PURE__*/
function (_HTMLElement) {
  (0, _inherits2.default)(AuthorSelectedOptionsElement, _HTMLElement);

  function AuthorSelectedOptionsElement() {
    var _this;

    (0, _classCallCheck2.default)(this, AuthorSelectedOptionsElement);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AuthorSelectedOptionsElement).call(this));
  ...
  (0, _createClass2.default)(AuthorSelectedOptionsElement, [{
    key: "add",
