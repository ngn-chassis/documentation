...
function (_AuthorElement) {
  ...
  function _class() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(_class).call(this, "<template><style>@charset \"UTF-8\"; :host{display:block}:host *,:host :after,:host :before{box-sizing:border-box}chassis-grid-cell{display:block}chassis-grid-cell *,chassis-grid-cell :after,chassis-grid-cell :before{box-sizing:border-box}</style><slot></slot></template>"));
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=chassis-grid-cell-es5-bundle.js.map