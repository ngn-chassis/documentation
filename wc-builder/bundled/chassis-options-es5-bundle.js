  ...
  return (
    ...
    function (_HTMLElement) {
      ...
      function _class() {
        ...
        _.set((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), {
          ...
          addAttribute: function addAttribute(prop) {
            ...
            if (!custom && typeof prop !== 'string') {
              return console.error('ERROR <chassis-options> Attribute must be type "object" or "string"');
            }
        ...
        _.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).addPrivateProperties((_$get$addPrivatePrope = {
        ...
        }), (0, _defineProperty2.default)(_$get$addPrivatePrope, "diffSelections", function diffSelections(comparator, comparable) {
          ...
          var _$get3 = _.get((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))),
              ...
              diffSelections = _$get3.diffSelections,
              getCurrentSelection = _$get3.getCurrentSelection,
              emit = _$get3.emit,
