...
function (_AuthorElement) {
  (0, _inherits2.default)(AuthorDropTargetElement, _AuthorElement);

  function AuthorDropTargetElement() {
    var _this;

    (0, _classCallCheck2.default)(this, AuthorDropTargetElement);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AuthorDropTargetElement).call(this));
    ...
    _this.UTIL.defineProperties({
      draggables: {
        ...
        readonly: true,
        get: function get() {
          return document.querySelectorAll('author-draggable');
        }
      }
    });
    ...
    _this.UTIL.registerListeners((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), {
      rendered: function rendered() {
        return _this.PRIVATE.applyDragListeners();
      }
    });

    _this.UTIL.registerListeners(document, {
      'author-draggable.connected': function authorDraggableConnected(evt) {} // pointermove: evt => {
      //   console.log(evt);
      // }
  ...
  (0, _createClass2.default)(AuthorDropTargetElement, null, [{
...
/***/ })
/******/ ]);
//# sourceMappingURL=author-droptarget-es5-bundle.js.map