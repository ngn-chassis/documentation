...
var AuthorCycleElement =
/*#__PURE__*/
function (_AuthorElement) {
  (0, _inherits2.default)(AuthorCycleElement, _AuthorElement);

  function AuthorCycleElement() {
    var _this;

    (0, _classCallCheck2.default)(this, AuthorCycleElement);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AuthorCycleElement).call(this));
  ...
  (0, _createClass2.default)(AuthorCycleElement, [{
    key: "hideAll",
...
customElements.define('author-cycle', AuthorCycleElement); // export default AuthorCycleElement
